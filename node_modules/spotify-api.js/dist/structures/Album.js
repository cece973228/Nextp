...
class Album {
    ...
    constructor(data, client) {
        this.artists = Cache_1.createCacheStructArray('artists', client, data.artists);
        ...
        this.uri = data.uri;
        if ('tracks' in data) {
            this.tracks = Cache_1.createCacheStructArray('tracks', client, Array.isArray(data.tracks) ? data.tracks : data.tracks.items);
    ...
    makeCodeImage(color = '1DB954') {
        return `https://scannables.scdn.co/uri/plain/jpeg/#${color}/${(Util_1.hexToRgb(color)[0] > 150) ? "black" : "white"}/1080/${this.uri}`;
    }
}
exports.Album = Album;
