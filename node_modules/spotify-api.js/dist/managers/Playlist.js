...
class PlaylistManager {
    ...
    async get(id, market = 'US', force = !this.client.cacheSettings.playlists) {
        ...
        return fetchedData ? Cache_1.createCacheStruct('playlists', this.client, fetchedData) : null;
    }
    /**
    ...
    async getTracks(id, options = {}) {
        ...
        return fetchedData ? Playlist_1.createPlaylistTracks(this.client, fetchedData.items) : [];
    }
    /**
