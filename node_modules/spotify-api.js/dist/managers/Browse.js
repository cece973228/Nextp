...
class BrowseManager {
    ...
    async getNewReleases(options) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('albums', this.client, fetchedData.albums.items) : [];
    }
    /**
    ...
    async getFeaturedPlaylists(options) {
        ...
        return fetchedData ? {
            ...
            playlists: Cache_1.createCacheStructArray('playlists', this.client, fetchedData.playlists.items)
        } : null;
    }
    /**
    ...
    async getCategoryPlaylists(id, options) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('playlists', this.client, fetchedData.playlists.items) : [];
    }
    /**
    ...
    async getRecommendations(options) {
        ...
        return fetchedData ? {
            ...
            tracks: Cache_1.createCacheStructArray('tracks', this.client, fetchedData.tracks)
        } : null;
    }
    /**
