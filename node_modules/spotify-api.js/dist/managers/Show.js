...
class ShowManager {
    ...
    async search(query, options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('shows', this.client, fetchedData.shows.items) : [];
    }
    /**
    ...
    async get(id, market = 'US', force = !this.client.cacheSettings.shows) {
        ...
        return fetchedData ? Cache_1.createCacheStruct('shows', this.client, fetchedData) : null;
    }
    /**
    ...
    async getMultiple(ids, market = 'US') {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('shows', this.client, fetchedData.shows) : [];
    }
    /**
    ...
    async getEpisodes(id, options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('episodes', this.client, fetchedData.items) : [];
    }
}
