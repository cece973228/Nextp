...
class TrackManager {
    ...
    async search(query, options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('tracks', this.client, fetchedData.tracks.items) : [];
    }
    /**
    ...
    async get(id, market = 'US', force = !this.client.cacheSettings.tracks) {
        ...
        return fetchedData ? Cache_1.createCacheStruct('tracks', this.client, fetchedData) : null;
    }
    /**
