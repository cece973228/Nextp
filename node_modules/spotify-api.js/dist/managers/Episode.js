...
class EpisodeManager {
    ...
    async search(query, options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('episodes', this.client, fetchedData.episodes.items) : [];
    }
    /**
    ...
    async get(id, market = 'US', force = !this.client.cacheSettings.episodes) {
        ...
        return fetchedData ? Cache_1.createCacheStruct('episodes', this.client, fetchedData) : null;
    }
    /**
    ...
    async getMultiple(ids, market = 'US') {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('episodes', this.client, fetchedData.episodes) : [];
    }
}
