...
class AlbumManager {
    ...
    async get(id, force = !this.client.cacheSettings.albums) {
        ...
        return fetchedData ? Cache_1.createCacheStruct('albums', this.client, fetchedData) : null;
    }
    /**
    ...
    async getMultiple(ids) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('albums', this.client, fetchedData.albums) : [];
    }
    /**
