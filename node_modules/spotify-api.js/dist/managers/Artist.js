...
class ArtistManager {
    ...
    async get(id, force = !this.client.cacheSettings.artists) {
        ...
        return fetchedData ? Cache_1.createCacheStruct('artists', this.client, fetchedData) : null;
    }
    /**
    ...
    async getMultiple(ids) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('artists', this.client, fetchedData.artists) : [];
    }
    /**
    ...
    async getTopTracks(id, market = 'US') {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('tracks', this.client, fetchedData.tracks) : [];
    }
    /**
    ...
    async getAlbums(id, options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('albums', this.client, fetchedData.items) : [];
    }
    /**
