...
class UserClient {
    ...
    async getPlaylists(options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('playlists', this.client, fetchedData.items) : [];
    }
    /**
     * Create a playlist.
     *
    ...
    async getFollowingArtists(options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('artists', this.client, fetchedData.artists.items) : [];
    }
    /**
    ...
    async getTopTracks(options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('tracks', this.client, fetchedData.items) : [];
    }
    /**
    ...
    async getTopArtists(options = {}) {
        ...
        return fetchedData ? Cache_1.createCacheStructArray('artists', this.client, fetchedData.items) : [];
    }
    /**
    ...
    async getSavedAlbums(options) {
        ...
        return fetchedData ? Cache_1.createCacheSavedStructArray('albums', this.client, fetchedData.items) : [];
    }
    /**
    ...
    async getSavedTracks(options) {
        ...
        return fetchedData ? Cache_1.createCacheSavedStructArray('tracks', this.client, fetchedData.items) : [];
    }
    /**
    ...
    async getSavedEpisodes(options) {
        ...
        return fetchedData ? Cache_1.createCacheSavedStructArray('episodes', this.client, fetchedData.items) : [];
    }
    /**
    ...
    async getSavedShows(options) {
        ...
        return fetchedData ? Cache_1.createCacheSavedStructArray('shows', this.client, fetchedData.items) : [];
    }
    /**
